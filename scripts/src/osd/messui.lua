...
project ("osd_" .. _OPTIONS["osd"])
	...
	files {
		...
		MAME_DIR .. "src/osd/winui/newui.c",
		...
		MAME_DIR .. "src/osd/winui/devview.c",
		...
		MAME_DIR .. "src/osd/winui/layoutms.c",
		MAME_DIR .. "src/osd/winui/messui.c",
		MAME_DIR .. "src/osd/winui/msuiutil.c",
		...
		MAME_DIR .. "src/osd/winui/optionsms.c",
		MAME_DIR .. "src/osd/winui/picker.c",
		MAME_DIR .. "src/osd/winui/properties.c",
		MAME_DIR .. "src/osd/winui/propertiesms.c",
		MAME_DIR .. "src/osd/winui/screenshot.c",
		MAME_DIR .. "src/osd/winui/softwarelist.c",
		MAME_DIR .. "src/osd/winui/softwarepicker.c",
		MAME_DIR .. "src/osd/winui/splitters.c",
		MAME_DIR .. "src/osd/winui/swconfig.c",
