...
CONS( 1986, stratos, 0,      0,      stratos, stratos, stratos_state, init_stratos, "SciSys",  "Kasparov Chess Computer: Stratos", MACHINE_MECHANICAL | MACHINE_NOT_WORKING | MACHINE_NO_SOUND)
