...
//  winui_output_error
//============================================================
// MESSUI Robbbert, 2022-11-18. The removed code was a total horrible hack and froze the system.
		...
		if (channel == OSD_OUTPUT_CHANNEL_ERROR)
		{
			...
			win_message_box_utf8(!osd_common_t::s_window_list.empty() ?
				std::static_pointer_cast<win_window_info>(osd_common_t::s_window_list.front())->platform_window() :
					nullptr, buffer.str().c_str(), "MESS", MB_OK);
// MESSUI end
		}
		else
		{
...
const options_entry windows_options::s_option_entries[] =
{
	...
	{ WINOPTION_MENU,                                 "1",        core_options::option_type::BOOLEAN,    "enables menu bar if available by UI implementation" },  // MESSUI
