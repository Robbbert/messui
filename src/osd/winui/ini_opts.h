...
const INIOPTS option_entries[] =
{
	...
	{ OSDOPTION_AUDIO_LATENCY "(0-0.5)",      "0",              OPTION_FLOAT,   "set audio latency (increase to reduce glitches, decrease for responsiveness)" },
	...
	{ WINOPTION_SHADOW_MASK_TEXTURE";fs_shadwt",                "shadow-mask.png",   OPTION_STRING,     "shadow mask texture name" },
