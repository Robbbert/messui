...
void ResetTreeViewFolders(void)
{
	...
	TVINSERTSTRUCT tvs;
	tvs.hInsertAfter = /*TVI_SORT;*/ TVI_LAST;
...
void SelectTreeViewFolder(int folder_id)
{
	...
	while (hti != NULL)
	{
		...
		tvi.mask = TVIF_PARAM;
		(void)TreeView_GetItem(hTreeView,&tvi);
		printf("SelectTreeViewFolder - A\n");fflush(stdout);
		LPTREEFOLDER tt = LPTREEFOLDER(tvi.lParam);
		//printf("SelectTreeViewFolder - B = %d\n",tt->m_nFolderId);fflush(stdout);
		printf("SelectTreeViewFolder - B\n");fflush(stdout);
		if (tt)
		{

		if (tt->m_nFolderId == folder_id)
		{
